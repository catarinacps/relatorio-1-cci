...
% título
\title{RELATÓRIO DA AULA PRÁTICA 2} 
...
Na Aula Prática 2, construimos o layout do inversor cujo esquemático foi concebido na última aula e o testamos utilizando as ferramentas do Vivado. Este relatório traz um resumo do processo e dos resultados obtidos ao seu fim.

\chapter{Vivado}\label{vivado}
